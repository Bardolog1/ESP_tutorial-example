...
//////////////////////////////////////////////
const char SSID_ESP[] = "DROGUERIAHAMBURGO.DC_2_GETB";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "L.DIANA1512";             //Add the password of that WIFI connection
const char* host = "sensoresarduino2022.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
String NOOBIX_id = "25301";                     //This is the ID you have on your database, I've used 99999 becuase there is a maximum of 5 characters
String NOOBIX_password = "25301";               //Add the password from the database, also maximum 5 characters and only numerical values
